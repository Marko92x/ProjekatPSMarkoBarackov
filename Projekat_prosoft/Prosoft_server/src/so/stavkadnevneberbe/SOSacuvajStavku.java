 ...
 * @author Mare
 */
public class SOSacuvajStavku extends AbstractSO {

    IDomenskiObjekat stavka;

    public SOSacuvajStavku(IDomenskiObjekat stavka) {
        this.stavka = stavka;
    }
    ...
    protected void izvrsiValidaciju() throws ValidationException {
        ...
        if (s.getDobavljac() == null || s.getDnevnaBerba() == null
                ...
                || s.getBraonTacne() < 0 || s.getBraonRimfuz() < 0 || s.getBukovaca() < 0
                || s.getCenaBraonTacne() < 0 || s.getCenaBraonRimfuz() < 0 || s.getCenaBukovaca() <0) {
    ...
    protected void izvrsiTransakciju() throws SistemOperationException {
        try {
            ...
            Logger.getLogger(SOSacuvajStavku.class.getName()).log(Level.SEVERE, null, ex);
            throw new SistemOperationException("Uneli ste stavku sa istim id-em");
        }
    }
